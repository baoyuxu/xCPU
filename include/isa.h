`ifndef ISA_H
	...
	`define ISA_EXP_NO_EXP 3'b000
	`define ISA_EXP_EXT_INT 3'b001
	`define ISA_EXP_UNDEF_INSN 3'b010
	`define ISA_EXP_OVERFLOW 3'b011
	`define ISA_EXP_MISS_ALIGN 3'b100
	`define ISA_EXP_TRAP 3'b101
	`define ISA_EXP_PRV_VIO 3'b110
